...
export class MedicamentService {
  ...
  findMedicamentsConsumedBetweenDates(dateDebut:any,dateFin:any):Observable<any>{
    return this.http.get<any>(this.url+"findMedicamentsConsumedBetweenDates/"+dateDebut+"/"+dateFin)
  }
  selectTop3ConsumedMedicaments():Observable<any>{
    return this.http.get<any>(this.url+"selectTop3ConsumedMedicaments")
  }
